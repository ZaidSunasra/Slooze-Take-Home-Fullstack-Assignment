...
import { addOrderController, cancelOrderController, editOrderController, getAllOrdersContoller, placeOrderController } from "./order.controller.js";
...
orderRouter.put("/edit/:id", authMiddleware, editOrderController)
